...
import ee
# Add Google Service account credential. Authenticates to the Earth Engine servers. Use your own Earth Engine account.
ee.Authenticate()
...
def server(input, output, session):
    ...
    global address_line, polygoned_image, center_flag, loc_flag
    address_line = None
